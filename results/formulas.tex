...
\item $$ |\psi_{out}\rangle = \Pi_{click} |\psi_{in}\rangle $$



\item First and only one ideal detector was clicked

\item $$ |\psi_4\rangle = \sum_{\substack{p_{1},p_{2},p_{4} \\ p_{1} > 0, p_{3}=0}} \beta_{p_{1},p_{2},0,p_{4}} \sqrt{p_{1}!p_{2}!p_{4}!} |p_{2}, p_{4}\rangle $$

\item First and third detectors were clicked

\item $$ |\psi_4\rangle = \sum_{\substack{p_{1},p_{2},p_{3},p_{4} \\ p_{1} > 0, p_{3}>0}} \beta_{p_{1},p_{2},p_{3},p_{4}} \sqrt{p_{1}!p_{2}!p_{3}!p_{4}!} |p_{2}, p_{4}\rangle $$

\item No detection

\item $$ |\psi_4\rangle = \sum_{\substack{p_{2},p_{4} \\ p_{1}=0, p_{3}=0}} \beta_{0,p_{2},0,p_{4}} \sqrt{p_{2}!p_{4}!}   |p_{2}, p_{4}\rangle $$
